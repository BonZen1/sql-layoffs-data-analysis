...
This project explores a real-world layoffs dataset using MySQL.
The goal was to clean raw data, perform exploratory data analysis, and identify meaningful trends across companies, industries, countries, and time.
...
03_key_insights.md
Summary of business insights derived from the analysis.
